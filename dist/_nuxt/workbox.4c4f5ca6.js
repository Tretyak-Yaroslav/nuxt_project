const workbox = (function () {
  'use strict'; try { self.workbox.v['workbox:sw:3.6.3'] = 1 } catch (t) {} const t = 'https://storage.googleapis.com/workbox-cdn/releases/3.6.3'; const e = { backgroundSync: 'background-sync', broadcastUpdate: 'broadcast-cache-update', cacheableResponse: 'cacheable-response', core: 'core', expiration: 'cache-expiration', googleAnalytics: 'google-analytics', navigationPreload: 'navigation-preload', precaching: 'precaching', rangeRequests: 'range-requests', routing: 'routing', strategies: 'strategies', streams: 'streams' }; return new class {
